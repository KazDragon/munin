...
TEST(aligned_layout_test, preferred_size_is_maximum_with_and_height_of_components)
{
...
class aligned_layouts
  : public testing::TestWithParam<aligned_layout_test_data>
{
};
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ValuesIn(std::vector<aligned_layout_test_data>{
        aligned_layout_test_data{
            munin::alignment_hlvt,
            { 10, 10 },
            { 4,  4  },
            { {0, 0}, {4, 4} }
        },
        aligned_layout_test_data{
            munin::alignment_hcvt,
            { 10, 10 },
            { 4,  4  },
            { {3, 0}, {4, 4} }
        },
        aligned_layout_test_data{
            munin::alignment_hrvt,
            { 10, 10 },
            { 4,  4  },
            { {6, 0}, {4, 4} }
        },
        ...
        aligned_layout_test_data{
            munin::alignment_hlvb,
            { 10, 10 },
            { 4,  4  },
            { {0, 6}, {4, 4} }
        },
        aligned_layout_test_data{
            munin::alignment_hcvb,
            { 10, 10 },
            { 4,  4  },
            { {3, 6}, {4, 4} }
        },
        aligned_layout_test_data{
            munin::alignment_hrvb,
            { 10, 10 },
            { 4,  4  },
            { {6, 6}, {4, 4} }
        },
