...
TEST_F(an_unfocused_basic_component_that_receives_focus, gains_focus_when_focus_is_set)
{
...
TEST_F(an_unfocused_basic_component_that_receives_focus, does_nothing_when_losing_focus)
{
...
TEST_F(an_unfocused_basic_component_that_receives_focus, gains_focus_when_next_focus_is_set)
{
...
TEST_F(an_unfocused_basic_component_that_receives_focus, gains_focus_when_previous_focus_is_set)
{
...
TEST_F(an_unfocused_basic_component_that_does_not_receive_focus, does_not_gain_focus_when_focus_is_set)
{
    component_.set_focus();
...
TEST_F(an_unfocused_basic_component_that_does_not_receive_focus, does_nothing_when_losing_focus)
{
    component_.lose_focus();
...
TEST_F(an_unfocused_basic_component_that_does_not_receive_focus, does_not_gain_focus_when_next_focus_is_set)
{
    component_.focus_next();
...
TEST_F(an_unfocused_basic_component_that_does_not_receive_focus, does_not_gain_focus_when_previous_focus_is_set)
{
    component_.focus_previous();
