...
class a_viewport_with_a_vertical_resize_strategy : public a_viewport
{
 public:
  a_viewport_with_a_vertical_resize_strategy()
  {
    viewport_ = munin::make_viewport(
        tracked_component_, munin::make_vertical_viewport_resize_strategy());
  }
};
...
TEST_F(
    a_viewport_with_a_vertical_resize_strategy,
    is_granted_vertical_but_not_horizontal_size_when_the_viewport_is_resized)
{
...
class a_viewport_with_a_horizontal_resize_strategy : public a_viewport
{
 public:
  a_viewport_with_a_horizontal_resize_strategy()
  {
    viewport_ = munin::make_viewport(
        tracked_component_, munin::make_horizontal_viewport_resize_strategy());
  }
};
...
TEST_F(
    a_viewport_with_a_horizontal_resize_strategy,
    is_granted_horizontal_but_not_vertical_size_when_the_viewport_is_resized)
{
  auto const tracked_preferred_size = terminalpp::extent{10, 10};
