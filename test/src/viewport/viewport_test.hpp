...
protected:
    viewport_mock_test_with_data()
    {
        ...
        static auto constexpr tracked_component_preferred_size =
            terminalpp::extent{6, 6};
        static auto constexpr viewport_size = terminalpp::extent{3, 3};

        // Set the preferred size of the tracked component.  It is tested
        // elsewhere that a viewport allows the tracked component its preferred
        // size.
        ...
        // Mock the cursor position of the tracked component so that it does
        // what it is told and announces it to the viewport.
        ON_CALL(*tracked_component_, do_set_cursor_position(_))
            .WillByDefault([this](terminalpp::point const &pos) {
...
class a_viewport : public a_viewport_with_mock_tracked_component,
                   public testing::Test
{
};
