...
TEST(a_vertical_strip_layout_with_one_component, has_a_preferred_size_of_that_component)
{
...
TEST(a_vertical_strip_layout_with_one_component, fills_height_but_not_width_with_component)
{
    static constexpr terminalpp::extent comp_preferred_size{80, 24};
...
TEST(a_vertical_strip_layout_with_multiple_components, plots_components_aside_each_other)
{
