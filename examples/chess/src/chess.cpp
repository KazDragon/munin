...
auto make_content(Button &button)
{
  return munin::view(
      ...
      munin::view(
          ...
          munin::view(
              ...
              munin::make_fill(R"(\[6\U2502)"_ete),
      ...
      munin::view(
          munin::make_compass_layout(),
          munin::make_fill(R"(\[6\U2500)"_ete),
...
int main()
{
  ...
  munin::console_application app{
      make_behaviour(), io_context, make_content(button)};
