...
// GET_CONTENT_BASIS
// ==========================================================================
terminalpp::point get_content_basis(
...
// GET_CONTENT_EXTENT
// ==========================================================================
terminalpp::extent get_content_extent(
    terminalpp::extent const &component_size,
    terminalpp::extent const &content_size)
{
    return {
...
// GET_CONTENT_BOUNDS
// ==========================================================================
terminalpp::rectangle get_content_bounds(
    terminalpp::extent const &component_size,
    terminalpp::extent const &content_size)
{
    return {
...
// HAS_ZERO_DIMENSION
// ==========================================================================
bool has_zero_dimension(terminalpp::rectangle const &bounds)
{
