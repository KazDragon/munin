...
// CONSTRUCTOR
// ==========================================================================
status_bar::status_bar(animator &anim)
  : pimpl_(boost::make_unique<impl>(anim))
{
}
    ...
    terminalpp::rectangle const &region) const
{
    ...
    auto const frame_1_time = *pimpl_->marquee_start_time_ + marquee_delay_time;
    ...
    if (character_index < message_width)
    {
        auto const next_frame_time =
          ...
          ? frame_1_time
          : frame_1_time
              + ((frame_number + 1) * marquee_frame_time);
